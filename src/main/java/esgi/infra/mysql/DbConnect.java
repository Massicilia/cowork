...
public class DbConnect {
    ...
    public static java.sql.Connection getConnection() {
        //String url = "jdbc:mysql://b78ab6ae03f754:358baaea@us-cdbr-iron-east-05.cleardb.net/heroku_bab9f081f17abbf?reconnect=true"; //jdbc:"+System.getenv( "JDBC_DATABSE_URL");//"jdbc:mysql://localhost:3306/cowork?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
